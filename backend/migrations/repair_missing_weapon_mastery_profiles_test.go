...
func TestMissingWeaponMasteryProfilesMigrationIsRegisteredBeforeLevelOneSpeciesRepairs(t *testing.T) {
	...
	index := registeredMigrationIndex(t, missingWeaponMasteryProfilesMigrationVersion)
	...
	if index == 0 || migrations[index-1].Version != crafterInPlayChoiceMigrationVersion {
