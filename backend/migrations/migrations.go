...
func conditionsAsEffects(db *sql.DB) error {
	queries := []string{
		...
		`INSERT INTO effects (name, description, card_number, effect_type, rarity, mechanics) VALUES
			...
			('Без сознания','Недееспособен, распластан; провал СИЛ/ЛВК; атаки по вам вблизи — крит.','COND-unconscious','condition','common','{"effects":[{"resolution":"auto","result":[{"kind":"modifier","applies_to":{"roll":"attack"},"op":"advantage","scope":"target"},{"kind":"modifier","applies_to":{"roll":"speed"},"op":"set","value":"0"},{"kind":"modifier","applies_to":{"roll":"saving_throw","filter":{"ability":"str"}},"op":"auto_fail"},{"kind":"modifier","applies_to":{"roll":"saving_throw","filter":{"ability":"dex"}},"op":"auto_fail"},{"kind":"modifier","applies_to":{"roll":"attack"},"op":"auto_crit","scope":"target","range":"melee"}]}],"includes":["incapacitated"]}'::jsonb)
