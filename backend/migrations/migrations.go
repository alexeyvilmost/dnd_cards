...
func GetAllMigrations() []Migration {
	return []Migration{
		...
		{
			Version:     miniMVPPostHitSpellTargetsMigrationVersion,
			Description: "Исправить цели заклинаний 1 уровня после попадания",
...
CREATE INDEX IF NOT EXISTS idx_roguelike_combat_replay ON roguelike_combat_events(run_id, combat_key, revision);`)
		...
		{
			Version:     "205_roguelike_defenses",
			Description: "Materialize undead and animated armor condition immunities and senses",
		...
		{
			Version:     "210_battle_master_evasive",
			Description: "Materialize Evasive Footwork with a single persisted superiority roll",
			Up:          materializeBattleMasterEvasive,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "211_battle_master_menacing",
			Description: "Materialize Menacing Attack with saved original attack damage context",
			Up:          materializeBattleMasterMenacing,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "212_battle_master_trip",
			Description: "Materialize Battle Master Trip Attack",
			Up:          materializeBattleMasterTrip,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "213_battle_master_goading",
			Description: "Materialize Battle Master Goading Attack",
			Up:          materializeBattleMasterGoading,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "214_battle_master_choices",
			Description: "Choose learned Battle Master maneuvers through existing Forge",
		...
		{
			Version:     "216_battle_master_parry",
			Description: "Materialize Battle Master Parry in held-damage reaction window",
			Up:          materializeBattleMasterParry,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "217_battle_master_rally",
			Description: "Materialize Battle Master Rally and learned maneuver choice",
			Up:          materializeBattleMasterRally,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "218_battle_master_pushing",
			Description: "Materialize Battle Master Pushing Attack with distance choice",
			Up:          materializeBattleMasterPushing,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "219_battle_master_feint",
			Description: "Materialize Battle Master Feinting Attack",
			Up:          materializeBattleMasterFeint,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "220_battle_master_checks",
			Description: "Materialize Battle Master skill check maneuvers",
			Up:          materializeBattleMasterChecks,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "221_battle_master_ambush",
			Description: "Materialize Battle Master Ambush and initiative choice",
			Up:          materializeBattleMasterAmbush,
			Down:        func(db *sql.DB) error { return nil },
		},

		{
			Version:     "222_battle_master_precision",
			Description: "Materialize Battle Master Precision Attack and post-miss continuation",
			Up:          materializeBattleMasterPrecision,
			Down:        func(db *sql.DB) error { return nil },
		},

		{
			Version:     "223_battle_master_lunging",
			Description: "Materialize Battle Master Lunging Attack and immediate movement facts",
			Up:          materializeBattleMasterLunging,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "224_battle_master_sweeping",
			Description: "Materialize learned Sweeping Attack",
			Up:          materializeBattleMasterSweeping,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "225_battle_master_riposte",
			Description: "Materialize learned Riposte with melee counterattacks",
			Up:          materializeBattleMasterRiposte,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "226_battle_master_bait_switch",
			Description: "Materialize Bait and Switch with authoritative position exchange",
			Up:          materializeBattleMasterBaitSwitch,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "227_battle_master_commander",
			Description: "Materialize Commander Strike with an Attack entry and ally reaction",
			Up:          materializeBattleMasterCommander,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "228_battle_master_maneuvering",
			Description: "Materialize Maneuvering Attack with ally reaction movement",
			Up:          materializeBattleMasterManeuvering,
			Down:        func(db *sql.DB) error { return nil },
		},
		{
			Version:     "229_battle_master_disarming",
			Description: "Materialize Disarming Attack with physical held-item drops",
			Up:          materializeBattleMasterDisarming,
			Down:        func(db *sql.DB) error { return nil },
		},
		...
		{Version: "233_psi_warrior_movement", Description: "Materialize Telekinetic Movement creature transport and recharge", Up: materializePsiWarriorMovement, Down: func(db *sql.DB) error { return nil }},
