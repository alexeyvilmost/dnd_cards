...
type Class struct {
	...
	MulticlassProficiencies *JSONMap               `json:"multiclass_proficiencies" gorm:"type:jsonb"`
...
type CreateClassRequest struct {
	...
	MulticlassProficiencies *JSONMap               `json:"multiclass_proficiencies"`
...
type ClassResponse struct {
	...
	ChoiceRecommendations   ChoiceRecommendations  `json:"choice_recommendations,omitempty"`
	IsSubclass              *bool                  `json:"is_subclass"`
	ParentClassID           *uuid.UUID             `json:"parent_class_id"`
	SubclassLevel           *int                   `json:"subclass_level"`
	RelatedEffects          *Properties            `json:"related_effects"`
...
func (cl Class) ToClassResponse() ClassResponse {
	return ClassResponse{
		...
		SkillChoices: cl.SkillChoices, MulticlassProficiencies: cl.MulticlassProficiencies, StartingEquipment: cl.StartingEquipment,
