...
func generateFantasyPrompt(cardName, description, rarity string) string {
	...
	prompt += "\nСтиль: традиционная книжная иллюстрация, реалистичная ручная отрисовка красками, естественная приглушённая палитра, проработанные текстуры металла, дерева, кожи и камня, мягкие тени." +
		"\nКомпозиция: предмет строго целиком в кадре, ничего не обрезано краями изображения, по центру, под лёгким диагональным наклоном, с отступом от краёв изображения не менее 10%." +
		"\nФон: полностью прозрачный. Позади предмета — только мягкое размытое акварельное пятно нейтрального серого или пастельного оттенка, как клякса на бумаге; пятно занимает лишь центральную часть, плавно растворяется к краям и не доходит до границ изображения. Никаких других объектов, сцен или окружения." +
