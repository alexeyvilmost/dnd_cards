...
CREATE TABLE cards (
    ...
    defense_type VARCHAR(20) CHECK (defense_type IN ('cloth', 'light', 'medium', 'heavy', 'cloth', 'light_armor', 'medium_armor', 'heavy_armor', 'shield', 'ring', 'necklace', 'cloak') OR defense_type IS NULL),
