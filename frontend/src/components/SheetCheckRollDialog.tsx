...
export default function SheetCheckRollDialog({ title, preview, request, onComplete, onCancel }: {
  ...
  if (roll) return <CombatPresentationDialog modeOverride="standard" beat={{ id: 'sheet-check', sourceId: 'sheet', sourceName: '', actionName: title, rollKind: request.kind, roll, cues: [] }} onClose={() => onComplete(roll)} />;
