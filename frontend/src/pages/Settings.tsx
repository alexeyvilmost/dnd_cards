      ...
      <div className="bg-white rounded-lg shadow divide-y divide-gray-100">
        ...
        <label className="flex items-start gap-4 p-5 cursor-pointer">
          ...
          <span>
            ...
            <span className="block text-sm text-gray-500 mt-1">
              Показывает на листе инструменты для добавления предметов, действий, эффектов,
              заклинаний и всех видов черт. Добавленные сущности проходят тот же пересчёт,
              что и выборы кузницы.
            </span>
          </span>
        </label>
