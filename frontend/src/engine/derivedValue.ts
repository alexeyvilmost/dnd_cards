 ...
 * аддитивные модификаторы. Набор расширяется данными (КД ×N способов, Пояс силы огра
 * как ещё один метод СИЛ и т.п.).
 *
 * Раньше это существовало только для КД и как if/else-каскад, бравший ПЕРВЫЙ подходящий
