...
export function combatActorDisplayName(actor: Pick<ActorState, 'name' | 'familiarState'>): string {
  return actor.familiarState ? familiarFormLabel(actor.familiarState.form.id) : actor.name;
}
