...
Ниже перечислены подробности его расы, класса и предыстории:

{% cut "Barbarian (Варвар)" %}
...
Equipment от варвара в данном примере не имеет значения, рассмотрим эффекты и действия.
...
{% cut "Hill\_dwarf (Холмовой дварф)" %}
