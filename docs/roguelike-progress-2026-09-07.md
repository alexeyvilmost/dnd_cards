...
| --- | --- | --- |
| 1: baseline and manifests | Isolated production branch; 18 monster candidates, 9 enabled; 27 random shop entries | Partial: fighter dependency closure and a versioned release content manifest remain |
...
| 7: monsters | 18 materialized records, only 9 with positive generation weight | Partial: goblin escape; zombie fortitude; wolf/dire-wolf prone size gate; spider/hobgoblin poison clauses; bugbear grab/drag; captain/veteran Parry remain gated |
